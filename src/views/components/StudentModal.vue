  ...
  <div class="student-modals">
    ...
    <v-dialog v-model="addModalLocal" max-width="600px" persistent>
      <v-card class="rounded-lg modal-card">
        ...
        <v-card-title
          class="blue white--text modal-header d-flex flex-row align-center justify-space-between"
        >
        ...
        <v-card-text class="pt-6">
          <v-form ref="addForm">
            <v-row>
              ...
              <v-col cols="12" sm="6">
                <v-text-field
                  v-model="newStudentLocal.surname"
                  label="Familya"
              ...
              <v-col cols="12" sm="6">
                <v-text-field
                  ...
                  color="blue"
                  maxlength="9"
                  @input="limitPhoneInput($event, 'newStudentLocal')"
                  :rules="[
                    (v) =>
                      v?.length === 9 ||
              ...
              <v-col cols="12" sm="6">
                <v-text-field
                  v-model="newStudentLocal.payment"
              ...
              <v-col cols="12" sm="6">
                <v-select
                  v-model="newStudentLocal.subject"
                  :items="subjects"
                  label="Fan"
              ...
              <v-col cols="12" sm="6">
                <v-select
                  v-model="newStudentLocal.teacher"
                  :items="teachers"
                  label="O'qtuvchi"
        ...
        <v-card-actions class="pa-4">
          ...
          <v-btn
            color="blue"
            :disabled="!isValidForm(newStudentLocal)"
    ...
    <v-dialog v-model="editModalLocal" max-width="600px" persistent>
      <v-card class="rounded-lg modal-card">
        <div class="modal-pattern"></div>
        <v-card-title
          class="primary white--text modal-header d-flex align-center justify-space-between"
        >
        ...
        <v-card-text class="pt-6">
          <v-form ref="editForm">
            <v-row>
              <v-col cols="12" sm="6">
                <v-text-field
                  v-model="editedStudentLocal.name"
                  label="Ism"
                  prepend-icon="mdi-account"
                  outlined
                  color="blue"
              ...
              <v-col cols="12" sm="6">
                <v-text-field
                  v-model="editedStudentLocal.surname"
                  label="Familya"
                  prepend-icon="mdi-account-details"
                  outlined
                  color="blue"
              ...
              <v-col cols="12" sm="6">
                <v-text-field
                  v-model="editedStudentLocal.phone"
                  label="Telefon raqam"
                  prepend-icon="mdi-phone"
                  outlined
                  type="number"
                  color="blue"
                  maxlength="9"
                  @input="limitPhoneInput($event, 'editedStudentLocal')"
                  :rules="[
                    (v) =>
                      v?.length === 9 ||
                      'Telefon raqam 9 ta raqamdan iborat bo\'lishi kerak',
              ...
              <v-col cols="12" sm="6">
                <v-text-field
                  v-model="editedStudentLocal.payment"
                  label="To'lov summasi"
                  prepend-icon="mdi-cash"
                  outlined
                  type="number"
              ...
              <v-col cols="12" sm="6">
                <v-select
                  v-model="editedStudentLocal.subject"
                  :items="subjects"
                  label="Fan"
                  prepend-icon="mdi-book"
                  outlined
              ...
              <v-col cols="12" sm="6">
                <v-select
                  v-model="editedStudentLocal.teacher"
                  :items="teachers"
                  label="O'qtuvchi"
                  prepend-icon="mdi-account-tie"
                  outlined
              ...
              <v-col cols="12">
                ...
                >
                  <template v-slot:activator="{ on, attrs }">
                    <v-text-field
                      v-model="editedStudentLocal.date"
                      label="Kelgan sanasi"
                      prepend-icon="mdi-calendar"
                      readonly
                      outlined
        ...
        <v-card-actions class="pa-4">
          ...
          <v-btn
            color="blue"
            :disabled="!isValidForm(editedStudentLocal)"
    ...
    <v-dialog v-model="deleteDialogLocal" max-width="420px">
      <v-card class="rounded-lg">
        <v-card-title
          class="error white--text d-flex align-center justify-space-between"
        >

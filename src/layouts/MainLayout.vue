      ...
      <v-list>
        <v-list-item>
          <v-list-item-content class="rounded m-auto text-center">
            <router-link to="/">
              <v-img src="../assets/images/logoLC.png" alt="Smart Academy Logo" max-width="150" class="mx-auto"
                transition="scale-transition"></v-img>
            </router-link>
            <v-list-item-title class="text-h5 pb-3 mt-4 font-weight-bold app-title">
              London LC
            </v-list-item-title>
          </v-list-item-content>
        </v-list-item>
